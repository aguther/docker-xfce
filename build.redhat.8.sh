...
# get username and password for redhat subscription
echo "RedHat Login for installing packages is needed:"
read -p "RedHat Username: " REDHAT_USERNAME
read -p "RedHat Password: " -s REDHAT_PASSWORD
echo

# set version(s)
VERSION=redhat-8-latest
